    ...
    visibleTasks.forEach(task => {
        ...
        card.innerHTML = `
            ...
            <div class="task-meta">
                ...
                <div class="task-actions" style="display: flex; justify-content: space-between; align-items: center; width: 100%; margin-top: 8px;">
                    <div class="task-move-group" style="display: flex; gap: 6px;">
                        ${moveButtonsHtml}
                    </div>
                    <button class="task-delete-btn" onclick="deleteTask('${task.id}')" title="Delete Task" style="background: rgba(255, 77, 77, 0.12); border: 1px solid rgba(255, 77, 77, 0.35); color: #ff4d4d; border-radius: 4px; padding: 3px 8px; cursor: pointer; font-size: 0.85rem;">🗑️ Delete</button>
                </div>
            </div>
        `;
